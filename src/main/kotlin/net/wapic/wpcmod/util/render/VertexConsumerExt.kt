...
fun VertexConsumer.line(
	...
	addVertex(pose, x1, y1, z1).setColor(color.getEffectiveColourRGB()).setLineWidth(lineWidth).setNormal(pose, normal)
	return addVertex(pose, x2, y2, z2).setColor(color.getEffectiveColourRGB()).setLineWidth(lineWidth).setNormal(pose, normal)
}
