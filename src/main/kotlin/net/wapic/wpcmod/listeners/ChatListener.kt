...
class ChatListener {
    ...
    companion object {
        private const val DUNGEON_START_MESSAGE: String = "§e[NPC] §bMort§f: Here, I found this map when I first entered the dungeon."
        private const val KUUDRA_START_MESSAGE: String = "§e[NPC] §cElle§f: Okay adventurers, I will go and fish up Kuudra!"
        private const val KUUDRA_END_MESSAGE: String = "§e[NPC] §cElle§f: POW! SURELY THAT'S IT! I don't think he has any more in him!"
    }
